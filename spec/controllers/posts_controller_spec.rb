...
RSpec.describe PostsController, type: :controller do
  ...
  context "member user CRUDing a post they don't own" do
    before do
  ...
  context "member user CRUDing a post they own" do
    before do
  ...
  context "admin CRUDing a post they don't own" do
    before do
      other_user.admin!
      create_session(other_user)
    end
  ...
  context "moderator CRUDing a post they don't own" do
    before do
